...
const EditarDenunciaScreen = () => {
    ...
    const fetchDenuncia = async () => {
      ...
      try {
        ...
        if (data.success && data.denuncia) {
          ...
          showErrorModal(
            data.message || "No se pudo obtener la información de la denuncia"
          );
  ...
  const handleUpdate = async () => {
    ...
    try {
      ...
      if (data.success) {
        Alert.alert("Éxito", "Denuncia actualizada correctamente", [
          {
            text: "OK",
            onPress: () => {
      ...
      <SafeAreaView style={styles.menuSuperior}>
        ...
        <View style={styles.loadingContainer}>
          ...
          <Text style={styles.loadingText}>
            Cargando información de la denuncia...
          </Text>
        </View>
      </SafeAreaView>
    );
    ...
    <SafeAreaView style={styles.menuSuperior}>
      ...
      <ScrollView contentContainerStyle={styles.contenedor}>
        <View style={styles.seccion}>
          ...
          <TextInput
            style={[styles.input, styles.multilineInput, { color: "#000" }]}
